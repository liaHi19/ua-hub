...
- **Never** add Claude (or any AI assistant) as a commit co-author. Do not append `Co-Authored-By: Claude ...` trailers or any "Generated with Claude Code" lines to commit messages or PR bodies.
- Commit messages describe the change only; no tooling attribution.
